...
import com.amazon.deequ.{JdbcContextSpec, VerificationSuite}
import org.scalamock.scalatest.MockFactory
import org.scalatest.WordSpec

class ConstraintRulesTest extends WordSpec with FixtureSupport with JdbcContextSpec
  with MockFactory{
  ...
  "CompleteIfCompleteRule" should {
    ...
    "return evaluable constraint candidates" in withJdbc { connection =>

      val dfWithColumnCandidate = JdbcDataset(getTableFull(connection))
  ...
  "UniqueIfApproximatelyUniqueRule" should {
    ...
    "return evaluable constraint candidates" in withJdbc { connection =>
      ...
      val (_, metricResult) = verificationResult.metrics.head
  ...
  "jdbc CategoricalRangeRule" should {
    "be applied correctly" in {
