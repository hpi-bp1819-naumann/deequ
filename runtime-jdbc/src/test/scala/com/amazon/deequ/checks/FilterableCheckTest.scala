...
import com.amazon.deequ.statistics.{Completeness, Compliance}
import com.amazon.deequ.utils.FixtureSupport
import org.scalatest.{Matchers, WordSpec}

class FilterableCheckTest extends WordSpec with Matchers with JdbcContextSpec with FixtureSupport {
