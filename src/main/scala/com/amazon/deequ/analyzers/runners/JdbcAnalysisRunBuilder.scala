...
class JdbcAnalysisRunBuilder(val table: Table) {
  ...
  protected var analyzers: Seq[JdbcAnalyzer[_, Metric[_]]] = Seq.empty
  ...
  protected var jdbcConnection: Option[Connection] = None
  protected var saveSuccessMetricsJsonPath: Option[String] = None
  protected var overwriteOutputFiles: Boolean = false

  protected def this(analysisRunBuilder: JdbcAnalysisRunBuilder) {

    this(analysisRunBuilder.table)
    ...
    jdbcConnection = analysisRunBuilder.jdbcConnection
    ...
    */
  def addAnalyzer(analyzer: JdbcAnalyzer[_, Metric[_]]): this.type = {
    analyzers :+= analyzer
    this
  }
  ...
  /**
    ...
    */
  def addAnalyzers(analyzers: Seq[JdbcAnalyzer[_, Metric[_]]]): this.type = {
  ...
  /**
    ...
    */
  def useJdbcConnection(
                       jdbcConnection: Connection)
    : JdbcAnalysisRunBuilderWithJdbcConnection = {

    new JdbcAnalysisRunBuilderWithJdbcConnection(this, Option(jdbcConnection))
  }

  def run(): JdbcAnalyzerContext = {
    JdbcAnalysisRunner.doAnalysisRun(
      table,
      analyzers,
...
class JdbcAnalysisRunBuilderWithRepository(
    analysisRunBuilder: JdbcAnalysisRunBuilder,
    usingMetricsRepository: Option[JdbcMetricsRepository])
  extends JdbcAnalysisRunBuilder(analysisRunBuilder) {
...
class JdbcAnalysisRunBuilderWithJdbcConnection(
    analysisRunBuilder: JdbcAnalysisRunBuilder,
    usingJdbcConnection: Option[Connection])
  extends JdbcAnalysisRunBuilder(analysisRunBuilder) {

  jdbcConnection = usingJdbcConnection
