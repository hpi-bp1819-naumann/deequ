...
object JdbcConstraint {
  ...
  def histogramConstraint(
    ...
    val constraint = JdbcAnalysisBasedConstraint[JdbcFrequenciesAndNumRows, Distribution, Distribution](
  ...
  def dataTypeConstraint(
    ...
    JdbcAnalysisBasedConstraint[DataTypeHistogram, Distribution, Double](JdbcDataType(column), assertion,
